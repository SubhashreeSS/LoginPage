...
var GoogleLoginProvider = class _GoogleLoginProvider extends BaseLoginProvider {
  ...
  initialize() {
    return new Promise((resolve, reject) => {
      try {
        this.loadScript(_GoogleLoginProvider.PROVIDER_ID, "https://apis.google.com/js/api.js", () => {
...
SocialAuthService.ɵfac = function SocialAuthService_Factory(t) {
  return new (t || SocialAuthService)(ɵɵinject("SocialAuthServiceConfig"));
};
SocialAuthService.ɵprov = ɵɵdefineInjectable({
...
SocialLoginModule.ɵfac = function SocialLoginModule_Factory(t) {
  return new (t || SocialLoginModule)(ɵɵinject(SocialLoginModule, 12));
};
SocialLoginModule.ɵmod = ɵɵdefineNgModule({
  type: SocialLoginModule,
  imports: [CommonModule]
});
SocialLoginModule.ɵinj = ɵɵdefineInjector({
  providers: [SocialAuthService],
  imports: [[CommonModule]]
});
(() => {
...
var MicrosoftLoginProvider = class _MicrosoftLoginProvider extends BaseLoginProvider {
  ...
  initialize() {
    return new Promise((resolve, reject) => {
      this.loadScript(_MicrosoftLoginProvider.PROVIDER_ID, "https://alcdn.msauth.net/browser/2.13.1/js/msal-browser.js", () => {
        var _a;
        try {
          const config = {
            auth: {
